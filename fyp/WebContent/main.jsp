...
<html>
    <head>
        ...
        <link href="EEK/assets/css/components.css" rel="stylesheet" type="text/css">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="./" class="waves-effect waves-primary logo"><object id="logo" data="EEK/assets/images/logo.svg" type="image/svg+xml" height="80"></object></a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="hidden-xs">
                                    <a href="javascript:void(0);" class="right-bar-toggle waves-effect waves-light"><i
                        ...
                        <ul class="in_top">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
									...
									<li><a href="dwell-time.html">Dwell Time</a></li>
                ...
                <div class="user-detail">
                    <div class="dropup">
                        <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true">
                            <img  src="EEK/assets/images/users/avatar-2.jpg" alt="user-img" class="img-circle">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
									...
									<h4 class="text-center no-margin">12 July 2017</h4>
                                </div>
                            </div>
                        </div>
						...
						<div class="m-l-80 m-r-80">
							<div class="row">
								...
								<div class="col-sm-6 col-lg-4">
									<div class="widget-simple-chart text-right card-box">
										...
										<p class="text-muted text-nowrap">Averge Dwell Time</p>
									</div>
								</div>
							</div>
							<!-- end row -->
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="card-box">
										<table class="heatTable" style="width:100%;">
											<thead>
												<tr>
													<th colspan="8">Average Dwell Time</th>
												</tr>
											</thead>
											<tbody>
												<tr>
												...
												<tr>
													...
													<td>230</td>
													<td>80</td>
													<td class="y-label">11下午</td>
												</tr>
											</tbody>
											<tfoot>
												<tr>
													<td class="x-label">Monday</td>
													<td class="x-label">Tuesday</td>
													<td class="x-label">Wednesday</td>
													<td class="x-label">Thursday</td>
													<td class="x-label">Friday</td>
													<td class="x-label">Saturday</td>
													<td class="x-label">Sunday</td>
												</tr>
											</tfoot>
										</table>
								...
								<div class="col-lg-6">
									<div class="card-box">
										<table class="retentionTable" style="width:100%;">
											<thead>
												<tr>
													<th></th>
													<th>第0週</th>
											...
											<tbody>
												<tr>
													<td class="y-label">6月11日 - 6月17日</td>
													<td>11000</td>
													<td>423</td>
													<td>249</td>
													<td>165</td>
												...
												<tr>
													<td class="y-label">6月17日 - 6月23日</td>
													<td>11000</td>
													<td>427</td>
													<td>206</td>
													<td>196</td>
												...
												<tr>
													<td class="y-label">6月23日 - 6月29日</td>
													<td>14000</td>
													<td>409</td>
													<td>266</td>
													<td>202</td>
												...
												<tr>
													<td class="y-label">6月29日 - 7月4日</td>
													<td>13000</td>
													<td>426</td>
													<td>219</td>
													<td></td>
												...
												<tr>
													<td class="y-label">7月4日 - 7月10日</td>
													<td>13000</td>
													<td>521</td>
													<td></td>
													<td></td>
                            ...
                            <div class="timeline-2">
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><strong><a href="javascript:void(0);" class="text-info">John Doe</a></strong> Uploaded a photo <strong>"DSC000586.jpg"</strong></p>
                                    </div>
                                </div>
                                ...
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><a href="" class="text-info">Jessi</a> attended a meeting with<a href="javascript:void(0);" class="text-success">John Doe</a>.</p>
                                        <p><em>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet tellus ut tincidunt euismod. "</em></p>
                                    </div>
                                </div>
                                ...
                                <div class="time-item">
                                    <div class="item-info">
                                        ...
                                        <p><strong><a href="javascript:void(0);" class="text-info">John Doe</a></strong>Uploaded 2 new photos</p>
                                    </div>
                                </div>
